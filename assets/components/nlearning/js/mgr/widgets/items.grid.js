...
Ext.extend(nlearning.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = nlearning.utils.getMenu(row.data['actions'], this, ids);
    ...
    getColumns: function () {
        return [{
            ...
            dataIndex: 'active',
            renderer: nlearning.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
            header: _('nlearning_grid_actions'),
            dataIndex: 'actions',
            renderer: nlearning.utils.renderActions,
            sortable: false,
            width: 100,
            id: 'actions'
        }];
    ...
    getTopBar: function () {
        return [{
            text: '<i class="icon icon-plus"></i>&nbsp;' + _('nlearning_item_create'),
            handler: this.createItem,
            scope: this
        }, '->', {
            xtype: 'nlearning-field-search',
            width: 250,
            listeners: {
                search: {
                    fn: function (field) {
