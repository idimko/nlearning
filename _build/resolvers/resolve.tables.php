...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('nlearning_core_path', null,
                    $modx->getOption('core_path') . 'components/nlearning/') . 'model/';
            $modx->addPackage('nlearning', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/nlearning/model/schema/nlearning.mysql.schema.xml';
